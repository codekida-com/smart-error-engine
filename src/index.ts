...
import { errorEngineOptions } from './core/config';
...
export { configure, init, errorEngineOptions, use, Plugin };
...
/**
 * Express error middleware that intercepts errors, formats them via errorEngine,
